        ...
        if($this->request->get('cvWorkExperiences')) {
            foreach($data as $k => $v) {
                $cvWorkExperiences[] = WorkExperience::create([
                    ...
                    'period_from' => $cv->setDateAttribute($this->request->input("cvWorkExperiences.".$k.".period_from")),
                    'period_to' => $cv->setDateAttribute($this->request->input("cvWorkExperiences.".$k.".period_to")),
